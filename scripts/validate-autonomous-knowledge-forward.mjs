...
for(const marker of ['fetchKnowledgeForwardRemoteDocument','mergeKnowledgeForwardEvidenceArchives','GitHub + local','Remote Archive','archiveConflicts','CONFLICT','knowledge-forward-data'])if(!ui.includes(marker))throw new Error(`Knowledge Forward UI missing autonomous marker: ${marker}`);
