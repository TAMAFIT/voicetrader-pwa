...
const required=[
  'index.html','styles.css','ui-hotfix.css','ui-layout.css','ui-viewport.css','manifest.webmanifest','sw.js',
...
if(!process.exitCode)console.log('PWA v0.4.4 viewport density + research integrity validation passed.');
