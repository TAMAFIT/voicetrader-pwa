const CACHE_NAME='voicetrader-shell-v0.6-null-market-controls';
const APP_SHELL=[
  './','./index.html','./styles.css','./ui-hotfix.css','./ui-layout.css','./ui-viewport.css','./research-evaluation.css','./manifest.webmanifest',
